...
.sl-header:after {
    ...
    background-color: ${socialSeparator.backgroundColor};
}`
      : "";
...
.tab-button:hover {
    color: ${
      tabButton.hoverColor === "autogenerated"
        ? tabButton.color
        : tabButton.hoverColor
    };
    background-color: ${
      tabButton.hoverBackground === "autogenerated"
        ? pSBC(0.2, tabButton.backgroundColor)
        : tabButton.hoverBackground
    };
    -VENDOR-transform: none;
}
.tab-button.current {
    color: ${activeTabButton.color};
    background-color: ${activeTabButton.backgroundColor};
